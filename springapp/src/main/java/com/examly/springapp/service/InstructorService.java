...
public class InstructorService {
	...
	public boolean authenticate(String name, String password) {
        Optional<Instructor> instOpt = repo.findByNameIgnoreCase(name);
        return instOpt.map(instructor -> instructor.getPassword().equals(password)).orElse(false);
    }
    public boolean updatePassword(Long id, String currentPassword, String newPassword) {
        return repo.findById(id).map(instructor -> {
